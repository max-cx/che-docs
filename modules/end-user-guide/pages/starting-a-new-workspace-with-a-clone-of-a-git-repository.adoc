...
+
NOTE: Each workspace has a unique URL: `pass:c,a,q[{prod-url}]#workspace__<unique_url>__`.
...
. A clone of the remote Git repository is present in the filesystem of the new workspace.
