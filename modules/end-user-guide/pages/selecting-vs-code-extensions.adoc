...
:navtitle: Selecting `VS Code` extensions
:description: Selecting Visual Studio Code extensions
:keywords: Visual Studio Code extension, user-guide
:page-aliases: adding-a-vscode-extension.adoc

[id="selecting-vs-code-extensions"]
= Selecting pass:[<!-- vale RedHat.TermsErrors = NO -->] pass:[<!-- vale RedHat.CaseSensitiveTerms = NO -->] VS Code extensions
