...
The embedded cloud IDE is the point of access for everything running in a {prod-short} workspace.

== Microsoft Visual Studio Code - Open Source

Microsoft Visual Studio Code - Open Source is the default cloud IDE.
